    ...
    corsHandler(req, res, async () => {// Use corsHandler to wrap async functions
        ...
        try {
            ...
            if(paymentCost === 100){
                ...
                res.status(200).json({
                message: "Recurring subscription created and payment completed successfully",
                success: true,
                });
                ...
                res.status(200).json({
                message: "1 month free trial subscription created and payment completed successfully",
                success: true,
                });
                ...
                res.status(200).json({
                message: "One time payment subscription created and completed successfully",
                success: true,
                });
            } 
        }catch(error) {
